...
public interface UIInterface {
	...
	/**
	 * if allow==true - allow option if allow==false - hide option
	 *
	 * @param allow
	 */
	 ...
	 * @param question
	 * @param player
	 *            the player who is trying to answer this question
	 */
	public void displayQuestion(Question question, String nickname);

	/**
	 * When activated, will update the players' properties: - Cash - Strikes -
	 * Assets Worth - Assets Amount
	 *
	 * @param player
	 */
	 ...
	 *
	 * @param buyAmount
	 *            the amount money you need to buy the asset (switch owner)
	 * @param rentAmount
	 *            the amount money you need to rent the asset (doesnt switch
	 *            owner)
	 * @param player
	 *            to show on screen
	 * @param AssetName
